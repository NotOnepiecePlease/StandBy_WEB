...
if (document.querySelector("#cleave-telefone")) {
    ...
    document.querySelector("#cleave-telefone").addEventListener("input", function (data) {
...
if (document.querySelector("#cleave-telefone-recado")) {
    ...
    document.querySelector("#cleave-telefone-recado").addEventListener("input", function (data) {
        if (data.inputType == "deleteContentBackward") {
...
if (document.querySelector("#cleave-cpf")) {
    ...
    document.querySelector("#cleave-cpf").addEventListener("input", function (data) {
