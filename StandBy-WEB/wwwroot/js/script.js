...
!(function (e) {
  ...
  function (e, t, n) {
    ...
    function r(e, t) {
      ...
      return "function" == typeof e
        ? e(t || {}, r)
        : { nodeName: e, attributes: t || {}, children: r, key: t && t.key };
    }
    function o(e, t, n, r) {
      var o,
        i = [].map,
        ...
        f = (function e(t, n, r) {
          for (var o in r)
            "function" == typeof r[o]
              ...
              : e(t.concat(o), (n[o] = v(n[o])), (r[o] = v(r[o])));
          return r;
        })([], l, v(t));
      return p(), f;
      function d(e) {
              ...
              if (o === r);
                ...
                var a = (function e(t, n) {
                  var r =
                    "string" == typeof t || "number" == typeof t
                      ...
                      : document.createElement(t.nodeName);
                  var o = t.attributes;
                  if (o) {
                    o.oncreate &&
                      c.push(function () {
                    ...
                    for (var i = 0; i < t.children.length; i++)
                      r.appendChild(e((t.children[i] = d(t.children[i])), n));
                ...
                for (var y = 0, b = 0; b < p.length; ) {
                  ...
                  if (l[m]) y++;
                    ...
                    if (null == S || s)
                      null == m && (e(n, f[y], h[y], p[b], i), b++), y++;
                    else {
                      var k = u[S] || [];
                      m === S
                        ? (e(n, k[0], k[1], p[b], i), y++)
                        : k[0]
                        ? e(n, n.insertBefore(k[0], f[y]), k[1], p[b], i)
                        : e(n, f[y], null, p[b], i),
                        (l[S] = p[b]),
                        b++;
                    }
      ...
      function y(e, t, n) {
        var r = {};
        return e.length
          ? ((r[e[0]] = e.length > 1 ? y(e.slice(1), t, n[e[0]]) : t), v(n, r))
          : t;
      }
      function m(e, t) {
      ...
      function w(e, t, n, r, o) {
        if ("key" === t);
          ...
          if ("string" == typeof n) e.style.cssText = n;
            ...
            for (var i in ("string" == typeof r && (r = e.style.cssText = ""),
            v(r, n))) {
          ...
          "o" === t[0] && "n" === t[1]
            ? ((t = t.slice(2)),
              e.events ? r || (r = e.events[t]) : (e.events = {}),
              (e.events[t] = n),
              n ? r || e.addEventListener(t, b) : e.removeEventListener(t, b))
            : t in e &&
              "list" !== t &&
              "type" !== t &&
              "draggable" !== t &&
      ...
      var t = e.split("").reduce(function () {
        ...
        return (
          (e =
            (e << 5) -
            e +
            (arguments.length > 1 ? arguments[1] : void 0).charCodeAt(0)) & e
        );
      });
      return btoa(t + "");
    };
      ...
      var t = function () {},
        ...
        d = function (t) {
          ...
          return (
            ...
            n(
              r({}, i, {
                rootProps: { oncreate: c(e, i), ondestroy: l(e, i) },
              }),
              e
            )
          );
  ...
  function (e, t, n) {
    ...
    (t.prettyPrint = r),
      (r.expresssion = function (e) {
        return { expresssion: e };
      });
    ...
    var c = (0, n(2).component)({
      ...
      actions: {
        ...
        toggleControls: function () {
          return function (e) {
            return { showControls: !e.showControls };
          };
        },
      },
      render: function (e) {
        ...
        return function (e, c) {
          ...
          return (0, r.h)("div", {}, [
            // (0, r.h)("div", { class: "title" }, "PatternLockJS"),
            ...
            (0, r.h)(
              ...
              (0, r.h)(a.default, {
                ...
                onComplete: function (e) {
                  // console.log("pass:", e.password);
                  if (e.password != "") {
                    var data = JSON.parse(e.password);
                    // console.log(getValue(data));
                    var t = e.hash;
                    return c.setPassword(getValue(data));
                  }
                  return c.setPassword(e.password);
                },
                grid: t[e.gridIndex],
  ...
  function (e, t, n) {
    ...
    var r = n(0),
      o = function (e) {
        var t = e.name,
          ...
          o = e.checked,
          i = e.onCheck;
        return (0, r.h)("label", { style: "padding: .3em .5em;" }, [
          (0, r.h)("input", {
            name: t,
            checked: o,
            type: "radio",
    ...
    t.OptionsGroup = function (e) {
      var t = e.list,
        ...
        i = e.name,
        a = e.selected;
      return (0, r.h)("div", { style: "padding: 1em 0;" }, [
        (0, r.h)(
          "div",
  ...
  function (e, t, n) {
    ...
    var u = function (e) {
        ...
        return function (n, o) {
          return (0, r.h)("span", { style: { color: e } }, t(n, o));
        };
      },
      c = u("#DB696F"),
      s = u("#1abcdc"),
      ...
      f = function (e, t) {
        ...
        return (0, r.h)(
          "div",
          { style: { paddingLeft: "".concat(7 * o, "px") } },
          t
        );
      },
      d = function (e) {
        ...
        return (0, r.h)(
          ...
          (0, r.h)(
            "div",
            {},
            (0, r.h)("span", { style: { color: "#cb89e6" } }, "const"),
            " lock = ",
            (0, r.h)(s, {}, "PatternLock"),
            "({",
            (0, r.h)(f, {}, [
              ...
              (0, r.h)("span", {}, [
                "document.",
                (0, r.h)(s, {}, "getElementById"),
                "(",
                (0, r.h)(l, { value: "myCanvas" }),
                ")",
              ]),
              ",",
            ]),
            Object.keys(t).map(function (e) {
              return (0,
              r.h)(f, {}, [(0, r.h)(c, {}, e), ": ", (0, r.h)(l, { value: t[e] }), ","]);
            }),
            "});"
          ),
          (0, r.h)(i.default, {
            text: "const lock = PatternLock(".concat(
              (0, o.prettyPrint)(
                (function (e) {
                  for (var t = 1; t < arguments.length; t++) {
                    var n = null != arguments[t] ? arguments[t] : {},
                  ...
                  {
                    $canvas: o.prettyPrint.expresssion(
  ...
  function (e, t, n) {
    ...
    var f = (0, a.component)({
      ...
      defaultProps: { onComplete: function () {} },
      onCreate: function (e, t) {
        var n = t.onComplete,
          r = l(t, ["onComplete"]);
        return function (t) {
      ...
      onReceiveProps: function (e, t, n) {
        (0, u.isEqual)(t, n) ||
          e.locker.map(function (e) {
            return e.setGrid
              .apply(e, c(t.grid).concat([!1]))
              .setTheme(t.theme, !1)
              .setThemeState(t.themeState, !1)
              .forceRender();
          });
      },
      render: function (e) {
  ...
  function (e, t, n) {
    ...
    var v = function (e) {
      ...
      y = { PATTERN_COMPLETE: "complete", PATTERN_START: "start" },
      m = { theme: "dark", grid: [3, 3], width: 300, height: 430 },
      g = (function () {
        function e(t) {
          var n = this;
          if (
            ...
            p(this, "recalculateBounds", function () {
              var e = document.body.getBoundingClientRect(),
                t = n.$canvas.getBoundingClientRect(),
                r = t.top - e.top;
              n.bounds = { x: t.left, y: r };
            }),
            ...
            p(this, "_onTouchMove", function (e) {
              if ((e && e.preventDefault(), n._isDragging)) {
                var t = {
                  x:
                    (0, i.prop)("pageX", e) ||
                    (0, i.prop)("touches.0.pageX", e) ||
                    0,
                  y:
                    (0, i.prop)("pageY", e) ||
                    (0, i.prop)("touches.0.pageY", e) ||
                    0,
                };
                (t = { x: t.x - n.bounds.x, y: t.y - n.bounds.y }),
            ...
            p(this, "isPointInCanvas", function (e) {
              var t = e.x,
                r = e.y;
              return (
                t <= n.dimens.width && t > 0 && r <= n.dimens.height && r > 0
              );
            }),
            ...
            p(this, "calculationLoop", function () {
              ...
              n._isDragging &&
                ...
                n.forEachNode(function (e, t) {
                  if (
                    Math.sqrt(
                      Math.pow(n.coordinates.x - e, 2) +
                        Math.pow(n.coordinates.y - t, 2)
                    ) <
                    n.themeState.dimens.node_radius + 1
                  ) {
                    var r = { row: e / n.interval.x, col: t / n.interval.y };
                    if (!n.isSelected(r))
                      return (
                        n.addIntermediaryNodes(r), n.selectedNodes.push(r), !1
                      );
                  }
                }),
            ...
            p(this, "renderLoop", function () {
              ...
              if (n._isDragging) {
                ...
                n.ctx.clearRect(0, 0, n.dimens.width, n.dimens.height),
                  n.renderGrid();
          ...
          (t = d({}, m, t)),
            ...
            this.setDimensions({ width: t.width, height: t.height }),
            this.initialize(t);
        }
        return (
          (function (e, t, n) {
          ...
          })(e, [
            {
              ...
              value: function (e) {
                ...
                (this.$canvas.width = this.dimens.width * t),
                  (this.$canvas.height = this.dimens.height * t),
            ...
            },
            {
              ...
              value: function (e, t) {
                var n =
                  ...
                  arguments[2];
                return this.rows === e && this.cols === t
                  ? this
                  : ((this.rows = e),
                    (this.cols = t),
            ...
            },
            {
              ...
              value: function (e) {
                var t =
                  !(arguments.length > 1 && void 0 !== arguments[1]) ||
                  arguments[1];
                if (e === u.default[this.theme] || e === this.theme)
                  return this;
                if (("string" == typeof e && (e = u.default[e]), !e))
                  throw v("theme");
                return (
                  (this.theme = e),
                  this.setThemeState("default", !1),
                  t && this.forceRender(),
                  this
                );
              },
            },
            {
              ...
              value: function (e) {
                ...
                return (
                  (this.themeState = this.theme[e || "default"] || {}),
                  (this.themeState.colors = d(
                    {},
                    this.theme.default.colors,
                    this.themeState.colors
                  )),
                  (this.themeState.dimens = d(
                    {},
                    this.theme.default.dimens,
                    this.themeState.dimens
                  )),
                  t && this.forceRender(),
                  this
                );
            ...
            },
            {
              ...
              value: function () {
                ...
                t(this.$canvas, "mousedown touchstart", this._onTouchStart),
                  t(this.$canvas, "mouseup touchend", this._onTouchStop),
                  t(window, "mousemove touchmove", this._onTouchMove),
                  t(window, "resize", this._onResize),
                  (0, a.raf)(this.renderLoop),
                  (0, a.raf)(this.calculationLoop);
              },
            },
            {
              key: "on",
            ...
            },
            {
              ...
              value: function () {
                var e = this.selectedNodes,
                  ...
                  n = "";
                e.length &&
                  ((n = (0, i.patternToWords)(e)), (t = (0, i.hashCode)(n))),
                  this.emit(y.PATTERN_COMPLETE, {
                    nodes: e,
                    password: n,
                    hash: t,
                  });
            ...
            },
            {
              ...
              value: function (e) {
                var t = this.getIntermediaryStepDirection(
                ...
                if (0 !== t.row || 0 !== t.col)
                  for (
                    var n = {
                      ...
                      r = Math.max(this.rows, this.cols),
                      o = 0;
                    o++ < r && (n.row !== e.row || n.col !== e.col);

                  )
                    this.isSelected(n) || this.selectedNodes.push(n),
                      (n = { row: n.row + t.row, col: n.col + t.col });
            ...
            },
            {
              ...
              value: function (e, t, n, r, o) {
                var i = this.themeState,
                  ...
                  s = a.node_core,
                  l = i.colors.primary;
                (this.ctx.lineWidth = o || u),
                  (this.ctx.fillStyle = n || l),
                  (this.ctx.strokeStyle = r || l),
                  this.ctx.beginPath(),
                  this.ctx.arc(e, t, s, 0, 2 * Math.PI),
                  this.ctx.fill(),
                  this.ctx.beginPath(),
                  this.ctx.arc(e, t, c, 0, 2 * Math.PI),
                  this.ctx.stroke();
              },
            },
            {
        ...
        o = {
          check: function (t) {
            return (function (e, t) {
              ...
              ? n.emit("MATCH_SUCCESS")
              : n.emit("MATCH_FAILURE");
          },
  ...
  function (e, t, n) {
    ...
    var r = function (e, t, n) {
      return t.split(" ").forEach(function (t) {
        return e.removeEventListener(t, n, { passive: !1 });
      });
    };
    t.unregisterEvent = r;
    t.registerEvent = function (e, t, n) {
      return (
        t.split(" ").forEach(function (t) {
          return e.addEventListener(t, n, { passive: !1 });
        }),
        function () {
          return r(e, t, n);
        }
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), (t.default = void 0);
    var r = {},
      o = { line_width: 6, node_radius: 20, node_core: 8, node_ring: 1 };
    (r.dark = {
      default: {
        colors: {
          accent: accentColor,
      ...
      success: { colors: { accent: "#51e980" } },
      failure: { colors: { accent: "#e74c3c" } },
    }),
      (r.light = {
        default: {
          colors: { accent: "#ae64cd", primary: "#34495e", bg: "#ecf0f1" },
          dimens: o,
        },
        success: { colors: { accent: "#27ae60" } },
        failure: { colors: { accent: "#e74c3c" } },
      });
    var i = r;
    t.default = i;
...
function getValue(data) {
  return data.map(function (item) {
    if (item.row === 1 && item.col === 1) {
      return 1;
    } else if (item.row === 2 && item.col === 1) {
      return 2;
    } else if (item.row === 3 && item.col === 1) {
      return 3;
    } else if (item.row === 1 && item.col === 2) {
      return 4;
    } else if (item.row === 2 && item.col === 2) {
      return 5;
    } else if (item.row === 3 && item.col === 2) {
      return 6;
    } else if (item.row === 1 && item.col === 3) {
      return 7;
    } else if (item.row === 2 && item.col === 3) {
      return 8;
    } else if (item.row === 3 && item.col === 3) {
      return 9;
    }
  });
}
