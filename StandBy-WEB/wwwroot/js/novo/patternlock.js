...
(function (factory) {
  ...
  var scrollKeys =
    ...
    _defineProperty(_scrollKeys, "38", true),
    _defineProperty(_scrollKeys, 34, true),
    _defineProperty(_scrollKeys, 35, true),
    _defineProperty(_scrollKeys, 36, true),
    _scrollKeys);
  ...
  function PatternLock(element, options) {
    ...
    function end() {
      console.log("end");
      var root = document.getElementById("inputPassPattern");
      root.innerHTML = getPattern();
      root.value = getPattern();
      console.log(root);
